...
environments {
    development {
        ...
        social {
            facebook {
                full_service_path = 'https://www.facebook.com'
    ...
    test {
        social {
            facebook {
                fullServicePath = "https://www.facebook.com"
                scheme = "https"
                host = "www.facebook.com"
                path = "dialog/oauth"
                app_id = 325116950986098
    ...
    production {
        ...
        social.facebook {
            scheme = "https"
            port = 80
            path = "www.facebook.com/dialog/oauth"
            prefix = "https://www.facebook.com/dialog/oauth"
            app_id = 325116950986098
            app_secret = d6cbc089fb5806fc5713b680861e6d04
        }
    }
